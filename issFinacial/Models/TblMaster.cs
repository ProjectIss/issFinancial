...
namespace issFinacial.Models
{
    public class TblMaster
    {
        ...
        public int AccountID { get; set; } // loan account id--ledger id--33
        public int GroupID { get; set; }   //loans under the group-PENDING loan and assets-id group master 
        ...
        public string UGroup { get; set; } // Account group--parent group--PENDING current asstes-12
